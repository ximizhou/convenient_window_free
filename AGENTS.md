...
- The NSIS installer and portable package must include the repository-root `LICENSE` and generated `THIRD-PARTY-NOTICES.txt`; artifact inventory checks must fail when either is missing or incomplete.
